...
<body>
    ...
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-check"></i> Tentang Situs</h4>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Gallery Dokumentasi</h2>
            </div>
        ...
        <div class="well">
            <div class="row">
                <div class="col-md-8">
                    <p>
						<i>Situs ini masih dalam tahap pengembangan. Kami sangat mengharap adanya feedback terkait layanan situs ini.</i>
					</p>
                </div>
            </div>
        </div>
