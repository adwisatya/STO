...
switch ($_GET['gid']){
	case 0:
		...
		$datay2 = array(21.96,21.96,21.96,21.96,21.96,21.96,21.96,52.3690,52.3690,52.3790,52.5290,53.7570,55.8750,58.0120,60.9430,63.9490,66.9680,70.0940,73.1080,76.4590,80.5120,84.5970,88.6860,92.5660,96.0440,99.1930,100.0000 );
		...
		break;
	case 1:
		$datay1 = array(10,22,33,44,56);
		$datay2 = array(30,34,55,76,98);
		$label = array('Senin','Selasa','Rabu','Kamis','Jumat');
		break;
}
// Setup the graph
